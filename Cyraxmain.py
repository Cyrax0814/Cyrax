...
def banner(console):
    ...
    brand_name = figlet_format('CYRAX TOOL', font='standard')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.yellow_to_red, f'      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @{__CHANNEL_USERNAME__}')) 
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:        
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, f'Friends: {friends_count}.'))
            car_data = data.get("carIDnStatus", {}).get("carGeneratedIDs", [])
            unique_car_data = set(car_data)
            car_count = len(unique_car_data)
            print(Colorate.Horizontal(Colors.yellow_to_red, f'Cars   : {car_count}.'))
...
def load_client_details():
    ...
    print(Colorate.Horizontal(Colors.yellow_to_red, f'==========[ {__CHANNEL_MENU__} ]=========='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.yellow_to_red, '{32}: Login Another Account    FREE'))
            print(Colorate.Horizontal(Colors.yellow_to_red, '{0} : Exit From CYRAX Menu     FREE'))
